  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "learn about june of's privacy policy and how we collect, use, and protect your personal information when you shop our sustainable fashion collection."
      );
    } else {
    ...
    if (canonicalLink) {
      canonicalLink.setAttribute(
        "href",
        "https://www.juneof.com/privacy-policy"
      );
    } else {
      const link = document.createElement("link");
      link.rel = "canonical";
      link.href = "https://www.juneof.com/privacy-policy";
    ...
    const privacyPolicySchema = {
      ...
      "@type": "WebPage",
      name: "privacy policy - june of",
      description:
        "learn about june of's privacy policy and how we collect, use, and protect your personal information when you shop our sustainable fashion collection.",
      url: "https://www.juneof.com/privacy-policy",
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 2,
            name: "privacy policy",
            item: "https://www.juneof.com/privacy-policy",
          },
        ],
      },
      publisher: {
    ...
    script.text = JSON.stringify(privacyPolicySchema);
    ...
    return () => {
      ...
      if (
        metaToRemove &&
        metaToRemove.getAttribute("content")?.includes("privacy policy")
      ) {
        document.head.removeChild(metaToRemove);
      }
      if (
        linkToRemove &&
        linkToRemove.getAttribute("href")?.includes("privacy-policy")
      ) {
          ...
          <div className="relative z-10 flex-grow p-8 bg-[rgba(0,0,0,0.02)] backdrop-blur-md">
            ...
            >
              ...
              <p>
                ...
                privacy policy describes how we collect, use, and disclose your
                personal information when you visit, use, or make a purchase or
                other transaction using the services or otherwise communicate
                with us. if there is a conflict between our terms of service and
                this privacy policy, this privacy policy controls with respect
              ...
              <p>
                transaction information including the items you view, put in
                your cart, add to your wishlist, or purchase, return, exchange
              ...
              <p>
                device information including information about your device,
                browser, or network connection, your ip address, and other
                unique identifiers.
              </p>
              <p>
                usage information including information regarding your
                interaction with the services, including how and when you
              ...
              <p>
                automatically through the services including from your device
                when you use our products or services or visit our websites, and
                through the use of cookies and similar technologies;
              </p>
              <p>
                from our service providers including when we engage them to
                enable certain technology and when they collect or process your
              ...
              <p>
                provide, tailor, and improve the services. we use your personal
                information to provide you with the services, including to
                perform our contract with you, to process your payments, to
                fulfill your orders, to remember your preferences and items you
                are interested in, to send notifications to you related to your
                account, to process purchases, returns, exchanges or other
              ...
              <p>
                ...
                to authenticate your account, to provide a secure payment and
                shopping experience, detect, investigate or take action
                regarding possible fraudulent, illegal, unsafe, or malicious
                activity, protect public safety, and to secure our services. if
                ...
                other access details with anyone.
              </p>
              ...
              <p>
                ...
                with respect to your personal information here shopify privacy
                portal link.
              </p>
              ...
              <p>
                ...
                knowledge that we &quot;share&quot; or &quot;sell&quot; (as
              ...
              <p>
                ...
                we transfer it to a third party, in certain circumstances and
              ...
              <p>
                ...
                you opt out, we may still send you non-promotional emails, such
              ...
              <p>
                ...
                policy on this website, update the &quot;last updated&quot; date
                and provide notice as required by applicable law.
              </p>
              ...
              <p>
                ...
                office@juneof.com or contact us at sasthamangalam, warriam,
                p-108, thiruvananthapuram, kl, 695010, in
              </p>
            </div>
          </div>
        </main>
